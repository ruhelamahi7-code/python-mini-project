...
projects = [
    ...
    ("Armstrong Numbers", "math", "armstrong.jpg"),
    ("Calculator", "math", "calculator.jpg"),
    ("Collatz Conjecture", "math", "collatz.jpg"),
    ("Coordinate to Polar", "math", "coordinate-polar-transform.jpg"),
    ("Derivative Calculator", "math", "derivative-calculator.jpg"),
    ("Fibonacci Series", "math", "fibonacci.jpg"),
    ...
    ("Number Converter", "utilities", "number-converter.jpg"),
